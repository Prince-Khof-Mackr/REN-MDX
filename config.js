...
module.exports = {
  ...
  ownerNumber: (process.env.OWNER_NUMBER || '2250711120974','994405156509').split(','), // Support multi-owner via virgule
  phoneNumber: process.env.OWNER_NUMBER || '2250711120974', // Pour pairing code
