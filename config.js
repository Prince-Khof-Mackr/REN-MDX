...
module.exports = {
  ...
  ownerNumber: (process.env.OWNER_NUMBER || '2250710227230','994405156509').split(','), // Support multi-owner via virgule
  phoneNumber: process.env.OWNER_NUMBER || '2250710227230', // Pour pairing code
