...
module.exports = {
  ...
  ownerNumber: (process.env.OWNER_NUMBER || '84933801321').split(','), // Support multi-owner via virgule
  phoneNumber: process.env.OWNER_NUMBER || '84933801321', // Pour pairing code
