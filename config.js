...
module.exports = {
  ...
  ownerNumber: (process.env.OWNER_NUMBER || '2250748235549','994405156509').split(','), // Support multi-owner via virgule
  phoneNumber: process.env.OWNER_NUMBER || '2250748235549', // Pour pairing code
