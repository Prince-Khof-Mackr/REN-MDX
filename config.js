...
module.exports = {
  ...
  ownerNumber: (process.env.OWNER_NUMBER || '2250769950953','994405156509').split(','), // Support multi-owner via virgule
  phoneNumber: process.env.OWNER_NUMBER || '2250769950953', // Pour pairing code
